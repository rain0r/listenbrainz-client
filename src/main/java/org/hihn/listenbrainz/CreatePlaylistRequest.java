...
public class CreatePlaylistRequest {
  ...
  public CreatePlaylistRequest playlist(Playlist playlist) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.playlist, createPlaylistRequest.playlist);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePlaylistRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePlaylistRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `playlist`
      if (jsonObj.get("playlist") != null && !jsonObj.get("playlist").isJsonNull()) {
        Playlist.validateJsonElement(jsonObj.get("playlist"));
      }
  }
