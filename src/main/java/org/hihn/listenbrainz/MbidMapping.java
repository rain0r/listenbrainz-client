...
public class MbidMapping {
  ...
  public MbidMapping artistMbids(List<UUID> artistMbids) {
    this.artistMbids = artistMbids;
    return this;
  }

  public MbidMapping addArtistMbidsItem(UUID artistMbidsItem) {
  ...
  public MbidMapping artists(List<TopReleasesForUserPayloadReleasesInnerArtistsInner> artists) {
    this.artists = artists;
    return this;
  }

  public MbidMapping addArtistsItem(TopReleasesForUserPayloadReleasesInnerArtistsInner artistsItem) {
  ...
  public MbidMapping caaId(Integer caaId) {
    this.caaId = caaId;
    return this;
  }
  ...
  public MbidMapping caaReleaseMbid(UUID caaReleaseMbid) {
  ...
  public MbidMapping recordingMbid(UUID recordingMbid) {
  ...
  public MbidMapping recordingName(String recordingName) {
  ...
  public MbidMapping releaseMbid(UUID releaseMbid) {
  ...
  public boolean equals(Object o) {
    ...
    MbidMapping mbidMapping = (MbidMapping) o;
    return Objects.equals(this.artistMbids, mbidMapping.artistMbids) &&
        Objects.equals(this.artists, mbidMapping.artists) &&
        Objects.equals(this.caaId, mbidMapping.caaId) &&
        Objects.equals(this.caaReleaseMbid, mbidMapping.caaReleaseMbid) &&
        Objects.equals(this.recordingMbid, mbidMapping.recordingMbid) &&
        Objects.equals(this.recordingName, mbidMapping.recordingName) &&
        Objects.equals(this.releaseMbid, mbidMapping.releaseMbid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(artistMbids, artists, caaId, caaReleaseMbid, recordingMbid, recordingName, releaseMbid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MbidMapping {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MbidMapping
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MbidMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MbidMapping is not found in the empty JSON string", MbidMapping.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MbidMapping.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MbidMapping` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MbidMapping.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MbidMapping' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MbidMapping> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MbidMapping.class));

       return (TypeAdapter<T>) new TypeAdapter<MbidMapping>() {
           @Override
           public void write(JsonWriter out, MbidMapping value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MbidMapping read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MbidMapping given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MbidMapping
   * @throws IOException if the JSON string is invalid with respect to MbidMapping
   */
  public static MbidMapping fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MbidMapping.class);
  }

  /**
   * Convert an instance of MbidMapping to an JSON string
   *
   * @return JSON string
   */
